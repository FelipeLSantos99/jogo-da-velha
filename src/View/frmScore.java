...
public class frmScore extends javax.swing.JFrame {
    ...
    public void mostrarJogadoresTabela() {
        ...
        try {
            ...
            ArrayList<JogadorDTO> lista = objJogadorDAO.listarJogadorTabela();
            int cont = 0;
            for (; cont < lista.size(); cont++) {
                model.addRow(new Object[]{
                    lista.get(cont).getNome(),
                    lista.get(cont).getScore()});
            }

        } catch (Exception erro) {
            JOptionPane.showMessageDialog(null, "MostrarJogadoresTabelaVIEW: " + erro);
        }
    }
}
